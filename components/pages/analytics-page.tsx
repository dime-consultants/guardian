      ...
      {showEmptyState ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:grid-cols-4">
            <Card className="border-border bg-card p-4 gap-1">
              ...
              <CardContent className="p-0">
                <div className="text-2xl md:text-3xl font-bold text-foreground">{processingEfficiency}%</div>
            ...
            <Card className="border-border bg-card p-4 gap-1">
              ...
              <CardContent className="p-0">
                <div className="text-2xl md:text-3xl font-bold text-foreground">{formatMinutes(timeSaved)}</div>
                <div className="flex items-center gap-1 mt-0.5">
            ...
            <Card className="border-border bg-card p-4 gap-1">
              ...
              <CardContent className="p-0">
                <div className="text-2xl md:text-3xl font-bold text-foreground">{invoicesProcessed.toLocaleString()}</div>
                <div className="flex items-center gap-1 mt-0.5">
            ...
            <Card className="border-border bg-card p-4 gap-1">
              ...
              <CardContent className="p-0">
                <div className="text-2xl md:text-3xl font-bold text-foreground">{manualInvoices.toLocaleString()}</div>
                <div className="flex items-center gap-1 mt-0.5">
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <Card className="border-border bg-card">
              <CardHeader>
                <CardTitle className="text-foreground">Processing Trend</CardTitle>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <Card className="border-border bg-card">
              <CardHeader>
                <CardTitle className="text-foreground">Current Accuracy</CardTitle>
