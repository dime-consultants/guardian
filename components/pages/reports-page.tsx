          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:grid-cols-4">
            <Card className="border-border bg-card p-4 gap-0">
              <CardContent className="p-0">
                <div className="text-2xl md:text-3xl font-bold text-card-foreground">{reports.length}</div>
            ...
            <Card className="border-border bg-card p-4 gap-0">
              <CardContent className="p-0">
                <div className="text-2xl md:text-3xl font-bold text-card-foreground">28.9 MB</div>
              ...
              <div className="space-y-3">
                {reports.map((report) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="mb-1">
                        <span className="font-medium text-card-foreground text-sm leading-snug">
                          {report.name}
                        </span>
                        {" "}
                        <span
