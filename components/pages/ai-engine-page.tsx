...
const pipelineOptions = [
  ...
  { value: "brnet-kra-match", label: "BRNET-KRA Matching" },
...
const recentInsights = [
  {
    ...
    description: "12 invoices show discrepancies between BRNET and KRA records. Total variance: KES 245,000",
    severity: "warning",
    timestamp: "2 hours ago",
    source: "BRNET-KRA Matching",
  },
  {
    id: 2,
    ...
    <div className="space-y-6 pb-2">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2 border-border bg-card">
          <CardHeader>
            <CardTitle className="text-foreground">Run Analysis</CardTitle>
            <CardDescription>
              ...
              <div className="space-y-2">
                ...
                <Select>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="brnet">BRNET System</SelectItem>
                    <SelectItem value="kra">KRA Portal</SelectItem>
                    <SelectItem value="safaricom">Safaricom Paybill</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-3 lg:grid-cols-1 lg:gap-3">
          <Card className="border-border bg-card p-3 gap-1">
            ...
            <CardContent className="p-0">
              <div className="text-xl md:text-2xl font-bold text-foreground">47</div>
          ...
          <Card className="border-border bg-card p-3 gap-1">
            ...
            <CardContent className="p-0">
              <div className="text-xl md:text-2xl font-bold text-foreground">156</div>
          ...
          <Card className="border-border bg-card p-3 gap-1">
            ...
            <CardContent className="p-0">
              <div className="text-xl md:text-2xl font-bold text-foreground">2.3s</div>
              <p className="text-xs text-muted-foreground mt-0.5">
